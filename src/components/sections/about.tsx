      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          <Card className="bg-card/50">
            ...
            <CardContent>
              <p className="text-foreground/80">Fondée en 2025, CHA-TEA est née de la volonté de créer une alternative durable et solidaire au marché immobilier traditionnel pour les Sénégalais et immigrés.</p>
            </CardContent>
          </Card>
          <Card className="bg-card/50">
            <CardHeader className="flex-row items-center gap-4">
